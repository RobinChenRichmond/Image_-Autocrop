...
for aa = 3:nfolders
    ...
    files = dir(fullfile('/home/gc7xv/Desktop/larger_dataset/',currentfoldername,'*.jpg'));
    nfiles = length(files);

    %browse all the images in each folder
    for ii = 1:nfiles
        currentfilename = files(ii).name;
        A = imread(fullfile('/home/gc7xv/Desktop/larger_dataset/', currentfoldername, currentfilename)) ;
        ...
        filepath = fullfile('/home/gc7xv/Desktop/Result3/',currentfoldername);
